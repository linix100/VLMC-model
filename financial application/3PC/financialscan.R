#for scaning Garch_text.txt data into letter by letter and training the data
financescan<-function(){
  library(VLMC)
  numberofslices<-1
  #this directory should be changed to 2PC ones
  directory1<-"/Users/Linix100/Documents/R/financial/1ST_PC/1PC_27INTERVALS.txt"
